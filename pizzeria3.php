...
<div class="w3-content" style="max-width:1100px">
  ...
  <div class="w3-row w3-padding-64" id="about">
    <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="images/merikortteli.png" class="w3-round w3-image w3-opacity-min" width="600" height="750">
    </div>

    <div class="w3-col m6 w3-padding-large">
      <h1 class="w3-center">Pizza Helsinki<br>
      <h5 class="w3-center">Tervetuloa</h5>
      <p class="w3-large">Täällä tehdään pizzoja. Ollaan tehty pizzoja pitkään 10 kokemuksella. Valmistamme kaikki itse.</p>
      <p class="w3-large w3-text-grey w3-hide-medium">Sijaitsemme Lapinlahdenkatu 13, 00180 Helsinki. Avoinna joka päivä vuorokauden ympäri. Puh 045 232 2578</p>
    </div>
  </div>
